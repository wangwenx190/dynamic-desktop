 ...
 */
class DD_SHARED_EXPORT QSimpleUpdater : public QObject
{
    Q_OBJECT
...
public:
    ...
    QString getDownloadFileName (const QString& url) const;
...
public slots:
    ...
    void setAutoUpdate (const QString& url, bool enabled = true);
